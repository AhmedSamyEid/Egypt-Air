  ...
  playPauseButton.addEventListener('click', function() {
      if (video.paused) {
          video.play();
           playPauseButton.textContent = 'إيقاف'; // تغيير النص إلى إيقاف
      } else {
          video.pause();
           playPauseButton.textContent = 'تشغيل'; // تغيير النص إلى تشغيل
      }
  });
  ...
  function loadPage(page) {
    ...
    // تغيير محتوى الـ div حسب الزر الذي تم الضغط عليه
